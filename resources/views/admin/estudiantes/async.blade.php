		...
		<div class="container-fluid">
		  	<div class="row">
		    	<div class="col-md-12">
					...
					<div class="col-md-3 form-group">
					    <label>Numero</label>
		              	<input type="text" name="nombre" maxlength="30" placeholder="Nombre de estudiante" class="form-control" required>
					</div>

					<div class="col-md-3 form-group">
					    <label>cedula</label>
		              	<input type="number" name="cedula" maxlength="30" placeholder="Cedula de estudiante" class="form-control" required>
					</div>
				</div>
		  		<div class="clearfix"></div>
		      	<div class="col-lg-12">
...
<script>
	$(document).ready(function(){
		$('#users').DataTable({
			...
			"processing": true,
			"serverSide": true,
			"ajax": "{{ route('admin.estudiantes.datatables') }}",
			"columns": [
